...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/clients/assets/css/404.css') }}?v={{ time() }}">
...
<body>
    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <h1>404</h1>
                    <h2>Ôi không! Bạn lạc đường rồi.</h2>
                    <p>Trang bạn đang tìm kiếm không tồn tại. Làm thế nào bạn đến được đây vẫn còn là một bí ẩn. Nhưng
                        bạn có thể nhấp vào nút bên dưới để quay lại trang chủ.</p>
                    <button class="btn green"><a href="/">Trang chủ</a></button>
                </div>
            </div>
        </div>
    </main>
    ...
    <script>
        // Hiển thị SVG sau khi tải
        gsap.set("svg", {
            visibility: "visible"
        });

        // Lắc nhẹ đầu & người phi hành gia
        gsap.to("#headStripe", {
            y: 0.5,
            rotation: 1,
            yoyo: true,
        ...
        // Xoay ngẫu nhiên các ngôi sao lớn
        gsap.to("#starsBig g", {
        ...
        burger.addEventListener('click', () => {
            const newState = burger.dataset.state === 'closed' ? 'open' : 'closed';
